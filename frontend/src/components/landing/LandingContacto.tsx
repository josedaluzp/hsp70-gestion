  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        {/* Map — 8px radius per DESIGN.md images */}
        <div className="w-full h-52 mb-6 overflow-hidden" style={{ borderRadius: "var(--radius-amp-img)", border: "1px solid var(--color-light-border)" }}>
          <iframe
          ...
          {contactItems.map((item) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: "var(--color-light-mist)", borderRadius: "var(--radius-amp-card)", color: "var(--color-orange-ember)" }}
              >
                {item.icon}
              </div>
              <div>
        ...
        <a
          ...
          className="cursor-pointer flex items-center justify-center gap-3 text-sm font-semibold text-white transition-opacity duration-200 hover:opacity-90 w-full sm:w-auto"
          style={{
